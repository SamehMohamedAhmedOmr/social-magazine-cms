...
export class EditComponent implements OnInit, OnDestroy, InitializeComponentInterface {
	...
	ngOnInit() {
		...
		this.page_name = this.translateService.instant('Components.USERS.profile');
	...
	initializeForm() {
		...
		this.form = this.formBuilder.group({
			...
			gender:[this.model.gender_id, Validators.required] ,
	...
	updateForm () {
		...
		this.model.gender_id = controls['gender'].value;
