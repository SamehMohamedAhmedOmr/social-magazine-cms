...
export class EditComponent implements OnInit, OnDestroy, InitializeComponentInterface {
	...
	initializeForm() {
		this.form = this.formBuilder.group({
			...
			stars:		[this.model.stars, Validators.required] ,
			image:		[''] ,
	...
	updateForm () {
		...
		this.model.image_id = (controls['image'].value) ?  controls['image'].value : this.model.image_id;
		this.model.stars = controls['stars'].value;
