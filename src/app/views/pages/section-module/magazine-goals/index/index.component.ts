...
export class IndexComponent implements OnInit , OnDestroy, IndexInterface , InitializeComponentInterface{
	...
	constructor(private cdr: ChangeDetectorRef ,
				public service: MagazineGoalsService,
	...
	ngOnInit() {
		...
		this.page_name = this.translateService.instant('Components.MAGAZINE_GOAL.name');
		this.content_name = this.translateService.instant('Components.MAGAZINE_GOAL.single');
	...
	pageIcon(){
		return SectionIconsName.magazineGoals();
	}
