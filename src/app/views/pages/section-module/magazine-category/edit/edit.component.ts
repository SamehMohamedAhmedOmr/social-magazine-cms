...
export class EditComponent implements OnInit, OnDestroy, InitializeComponentInterface {
	...
	constructor(private formBuilder: FormBuilder ,
				private service: MagazineCategoriesService,
	...
	ngOnInit() {
		...
		this.page_name = this.translateService.instant('Components.MAGAZINE_CATEGORY.name');
		this.content_name = this.translateService.instant('Components.MAGAZINE_CATEGORY.single');
		this.dialog_title = this.translateService.instant('Components.MAGAZINE_CATEGORY.add_image');
	}
	...
	updateForm () {
		...
		this.model.images = (controls['images'].value) ?  controls['images'].value : this.model.images;
